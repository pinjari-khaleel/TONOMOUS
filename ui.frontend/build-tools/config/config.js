...
*/
let publicPath = '/';
let clientLibRoot = undefined;
let clientLibName = undefined;
let clientLibCategory = undefined;
let clientLibSeparateEditorStyles = false;
...
if (argv.clientLibCategory) {
  clientLibCategory = argv.clientLibCategory;
}

if (argv.clientLibSeparateEditorStyles) {
  clientLibSeparateEditorStyles = true;
}
...
// force trailing /
if (clientLibRoot != undefined && !clientLibRoot.endsWith('/')) {
...
if (clientLibRoot != undefined && clientLibRoot !== '/') {
  console.log('');
  console.log(`${chalk.yellow('Note:')} clientLibRoot set to "${chalk.blue(clientLibRoot)}"`);
  console.log('');
}

if (clientLibName != undefined && clientLibName !== '') {
  console.log('');
...
module.exports = Object.assign({}, storyBookConfig, {
  buildTypes,
