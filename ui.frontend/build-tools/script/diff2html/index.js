...
const questions = [
  {
    type: 'list',
    name: 'from',
    message: `The script will generate diff reports for handlebars templates.\n What do you want to use as a first part of comparison, your ${chalk.yellow(
      'previous',
    )} version ?`,
    choices: [
      {
  ...
  },
  {
    type: 'list',
    name: 'to',
    message: `What do you want to use as a second part of comparison, your ${chalk.yellow(
      'current',
    )} version ?`,
    choices: [
      {
...
inquirer.prompt(questions).then((answers) => {
  ...
  console.log('');
  console.log(
    `Diff output generated at ${chalk.blue(
      path.resolve(addRootDir.get(), OUTPUT_DIR, REPORT_NAME),
    )}`,
  );
  console.log('');
