...
import S12BuHeader from './S12BuHeader';

class S12BuHeaderTransitionController extends AbstractTransitionController {
  /**
...
export default S12BuHeaderTransitionController;
