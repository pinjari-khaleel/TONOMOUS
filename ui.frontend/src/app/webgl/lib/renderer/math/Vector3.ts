...
export default class Vector3 {
  ...
  public transformMat3(transformMatrix: Matrix3x3): Vector3 {
    const x = this.x,
      y = this.y,
      z = this.z,
      m = transformMatrix.m;
  ...
  public static transformMat3(a: Vector3, transformMatrix: Matrix3x3): Vector3 {
    return a.clone().transformMat3(transformMatrix);
  }
