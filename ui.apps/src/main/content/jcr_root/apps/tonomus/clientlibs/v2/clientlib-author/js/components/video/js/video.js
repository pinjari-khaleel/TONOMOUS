(function(document, $, Coral) {
    ...
    var selectors = {
        ...
        embeddableField: "[data-cmp-video-dialog-edit-hook='embeddableField']",
        typeField: "[data-cmp-video-dialog-edit-hook='typeField']",
        typeRadio: "[data-cmp-video-dialog-edit-hook='typeField'] coral-radio",
        urlField: "[data-cmp-video-dialog-edit-hook='urlField']",
        urlStatus: "[data-cmp-video-dialog-edit-hook='urlStatus']",
        videoField: "[data-cmp-video-dialog-edit-hook='videoField']"
    };
    ...
    $(document).on("dialog-loaded", function(event) {
        ...
        if ($dialog.length) {
            ...
            if (dialogContent) {
                ...
                videoField = dialogContent.querySelector(selectors.videoField);
                    ...
                    for (var i = 0; i < typeRadios.length; i++) {
                        ...
                        Coral.commons.ready(typeRadio, function(element) {
                            ...
                            element.on("change", function() {
                                ...
                                if (videoField && (value === type.INTERNAL)) {
                                    videoField.trigger("change");
                                }
                            });
                        });
                    }
    ...
    function toggleShowHideTabs(values) {
        var panelElements = document.querySelectorAll("[data-cmp-video-dialog-edit-embeddableoptions]");
    ...
    function getShowHideTarget(element) {
        return element.dataset["cmpVideoDialogEditShowhidetarget"];
    }
    ...
    function getShowHideTargetValue(element) {
        return element.dataset["cmpVideoDialogEditShowhidetargetvalue"];
    }
